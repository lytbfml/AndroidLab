...
public class AgendaDataSource {
	 ...
	 * @return An instance of AgendaDataSource
	 */
	...
	public Event getEvent(long id) {
		Log.d("getEvent", "ID = " + Long.toString(id));
		String idString[] = {id + ""};
		Cursor cursor = database.query(SQLiteHelper.TABLE_EVENTS, allColumns,
				SQLiteHelper.COLUMN_ID + "=?", idString, null, null, null);
		cursor.moveToFirst();
